...
<div class="relative transition-colors bg-background-primary text-text-primary h-svh w-svw">
	<main class="w-full h-[calc(100%-5rem)] grid grid-cols-2 gap-4 p-4 relative">
		...
		<article class="col-span-2 flex flex-col justify-evenly border-2 border-background-secondary rounded-md gap-4">
			<HeaderSetup />
			<MonthlyExpenseChart />
		</article>
